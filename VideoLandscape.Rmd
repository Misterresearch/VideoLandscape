...
The Nielsen + Pivotal Research projections is based on a custom calculation which is readily documented anywhere, and only spans eight years. However, it does offer aggregate counts for very specific platforms using Nielsen data. It can also further segmented, in ways that it was not for this study. 
